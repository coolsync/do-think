...
function createRouter({ history, routes, scrollBehavior, parseQuery: parseQuery$1 = parseQuery, stringifyQuery: stringifyQuery$1 = stringifyQuery, }) {
    ...
    function finalizeNavigation(toLocation, from, isPush, replace, data) {
        ...
        handleScroll(toLocation, from, savedScroll || (state && state.scroll)).catch(err => triggerError(err, false));
...
export { Link, START_LOCATION_NORMALIZED as START_LOCATION, View, createMemoryHistory, createRouter, createWebHashHistory, createWebHistory, onBeforeRouteLeave, parseQuery, stringifyQuery, useLink, useRoute, useRouter };
